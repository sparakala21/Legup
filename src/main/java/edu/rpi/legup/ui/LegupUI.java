...
//
//public class LegupUI implements IHistoryListener
//{
...
//
//    protected JMenu edu.rpi.legup.ai = new JMenu("AI");
...
//
//        setIconImage(new ImageIcon(ClassLoader.getSystemClassLoader().getResource("images/edu.rpi.legup.Legup/Basic Rules.gif")).getImage());
//
...
//            URL resourceLocation = ClassLoader.getSystemClassLoader().getResource("images/edu.rpi.legup.Legup/" + toolBarName + ".png");
...
//    {
//        Puzzle edu.rpi.legup.puzzle = GameBoardFacade.getInstance().getPuzzleModule();
...
//            try
//            {
//                PuzzleExporter exporter = edu.rpi.legup.puzzle.getExporter();
//                if(exporter == null)
//                {
...
//
//        if(edu.rpi.legup.puzzle.isPuzzleComplete())
//        {
...
//    }
//
//    public void setPuzzleView(Puzzle edu.rpi.legup.puzzle)
//    {
////        this.boardView = edu.rpi.legup.puzzle.getBoardView();
////        this.topHalfPanel.setRightComponent(boardView);
////        this.topHalfPanel.setVisible(true);
////
////        this.treePanel.getTreeView().resetView();
////        this.treePanel.getTreeView().setTree(edu.rpi.legup.puzzle.getTree());
////
////        edu.rpi.legup.puzzle.addTreeListener(treePanel.getTreeView());
////        edu.rpi.legup.puzzle.addBoardListener(edu.rpi.legup.puzzle.getBoardView());
////
////        ruleFrame.getBasic_rules_tab().setRules(edu.rpi.legup.puzzle.getBasicRules());
////        ruleFrame.getCase_rules_tab().setRules(edu.rpi.legup.puzzle.getCaseRules());
////        ruleFrame.getContradiction_rules_tab().setRules(edu.rpi.legup.puzzle.getContradictionRules());
////
